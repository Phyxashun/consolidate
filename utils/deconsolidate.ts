...
interface RunOptions {
    ...
    inputPaths: string[];
    /** Root directory where reconstructed files will be written. */
    outputDir: string;
    /** When true, existing files are silently overwritten without prompting. */
    force: boolean;
    /** When true, print every reconstructed path; otherwise only print a summary. */
    verbose: boolean;
...
${styleText('yellow', 'Options:')}
  -o, --out <dir>     Output directory for reconstructed files.
